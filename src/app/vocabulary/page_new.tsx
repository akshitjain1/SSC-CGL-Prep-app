    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white/80 mb-4">Preparing 10 amazing words for you...</p>
              ...
              <div className="flex justify-between items-start mb-6">
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="text-xs text-gray-400">Word #{index + 1}</span>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="border-t-2 border-gray-100 pt-4">
                  ...
                  {word.userExample ? (
                    ...
                    <button
                      onClick={() => setActiveWordId(word.id)}
                      className="flex items-center justify-center w-full p-4 border-2 border-dashed border-gray-300 rounded-xl text-gray-500 hover:border-blue-400 hover:text-blue-600 hover:bg-blue-50 transition-all duration-200"
                    >
