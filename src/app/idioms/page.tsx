    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-200 mb-4">Preparing powerful expressions for you...</p>
          ...
          <div className="stat-card">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-700">Practiced</div>
              </div>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-xs font-medium text-gray-700 bg-gray-100 px-3 py-1 rounded-full ml-3">
                    #{index + 1}
                  </span>
                </div>
                ...
                <div className="border-t-2 border-gray-100 pt-4">
                  ...
                  {idiom.userSentence ? (
                    ...
                    <button
                      ...
                      className="flex items-center justify-center w-full p-4 border-2 border-dashed border-gray-400 rounded-xl text-gray-700 hover:border-purple-400 hover:text-purple-600 hover:bg-purple-50 transition-all duration-200"
                    >
